...
public class PlayerMenu {
    ...
    public static void openMenu(Player player, List<String> playerslist, HashMap<String,Material> playerItem, int maxplayers) {
        ...
        for (int i=0;i< playerslist.size();i++) {
            ...
            gui.setItem(i,PlayerHead.getPlayerHead((String) playerslist.get(i),playerItem));
        }
